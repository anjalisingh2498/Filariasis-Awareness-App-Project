    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.option_Dentiste:
                DoctorAdapterFiltred.specialiteSearch = true;
                adapter.getFilter().filter("Expert Filariasis Doctor");
                return true;
            case R.id.option_Ophtalmologue:
                DoctorAdapterFiltred.specialiteSearch = true;
                adapter.getFilter().filter("Nurse");
                return true;
            case R.id.option_ORL:
                DoctorAdapterFiltred.specialiteSearch = true;
                adapter.getFilter().filter("Staff");
                return true;
            case R.id.option_Pédiatre:
                DoctorAdapterFiltred.specialiteSearch = true;
                adapter.getFilter().filter("Junior Doctor");
                return true;
            case R.id.option_Radiologue:
                DoctorAdapterFiltred.specialiteSearch = true;
                adapter.getFilter().filter("Intern");
                return true;
            case R.id.option_Rhumatologue:
                DoctorAdapterFiltred.specialiteSearch = true;
                adapter.getFilter().filter("Medicine Incharge");
                return true;
            default:
